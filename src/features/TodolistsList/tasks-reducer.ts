...
export function* removeTaskSaga(action:ReturnType<typeof removeTaskS>){
    yield call(todolistsAPI.deleteTask,action.todolistId, action.taskId)
    yield put(removeTaskAC( action.taskId,action.todolistId))
}
export const removeTaskS =(taskId: string, todolistId: string)=>({type:"TASK/REMOVE-TASK", todolistId, taskId})
// thunks
